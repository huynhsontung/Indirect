...
namespace Indirect.Controls
{
    ...
    public partial class ExtendedMasterDetailsView
    {
        ...
        /// <summary>
        /// Identifies the <see cref="MasterListHeader"/> dependency property.
        /// </summary>
        /// <returns>The identifier for the <see cref="MasterListHeader"/> dependency property.</returns>
        ...
        /// <summary>
        /// Identifies the <see cref="MasterListHeaderTemplate"/> dependency property.
        /// </summary>
        /// <returns>The identifier for the <see cref="MasterListHeaderTemplate"/> dependency property.</returns>
        ...
        public static readonly DependencyProperty CompactModeThresholdWidthProperty = DependencyProperty.Register(
            ...
            typeof(double),
            typeof(ExtendedMasterDetailsView),
            new PropertyMetadata(500d, OnCompactModeThresholdWidthChanged));

        /// <summary>
        /// Identifies the <see cref="IntermediateModeThresholdWidth"/> dependency property
        /// </summary>
        public static readonly DependencyProperty IntermediateModeThresholdWidthProperty = DependencyProperty.Register(
            nameof(IntermediateModeThresholdWidth),
            typeof(double),
            typeof(ExtendedMasterDetailsView),
            new PropertyMetadata(720d, OnIntermediateModeThresholdWidthChanged));
        ...
        /// <summary>
        /// Gets or sets the Threshold width that will trigger the control to go into intermediate mode,
        /// where compact threshold &lt; actual width &lt;= this value  
        /// </summary>
        public double IntermediateModeThresholdWidth
        {
            get => (double)GetValue(IntermediateModeThresholdWidthProperty);
            set => SetValue(IntermediateModeThresholdWidthProperty, value);
        }
