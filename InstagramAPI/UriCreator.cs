    ...
    public class UriCreator
    {
        ...
        public static Uri GetDirectInboxUri(string nextId = "")
        {
            ...
            return !string.IsNullOrEmpty(nextId)
                ? new UriBuilder(instaUri) { Query = $"persistentBadging=true&cursor={nextId}&direction=older&limit=10&thread_message_limit=10" }.Uri
                 : new UriBuilder(instaUri) { Query = "persistentBadging=true&limit=10&thread_message_limit=10" }.Uri;
        }
