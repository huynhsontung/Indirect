...
namespace InstantMessaging.CustomMasterDetailsView
{
    /// <summary>
    ...
    {
        public static readonly DependencyProperty MasterItemsPanelProperty = DependencyProperty.Register(
            nameof(MasterItemsPanel),
        ...
        public ItemsPanelTemplate MasterItemsPanel
        {
            get { return (ItemsPanelTemplate) GetValue(MasterItemsPanelProperty); }
            set { SetValue(MasterItemsPanelProperty, value); }
        }
